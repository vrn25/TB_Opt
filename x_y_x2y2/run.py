...
from optimizers_generic import linear_linear, bilinear_bilinear, linear_bilinear, bilinear_linear
...
game = [None, 1, 2, 4] meas player maximizes y + x2y4 and player minimizes y + x2y4
...
save_xys=False#True
#x_max_lin, y_min_lin = [], []
seeds=[99, 7, 87, 16, 25] # generated randomly
print(seeds)
c_rounds_list = []
for i in range(len(seeds)):
    ...
    for level1 in levels1:
        for level2 in levels2:
            case, exp = 'L-L', 2
            x, y, n1, n2, cr = run_game(seed_idx=i, lr1=lr1, lr2=lr2, train_rounds=2000, level1=level1, level2=level2, game=[1,1,2,2], plot_figures=False, print_vals=True, p1_first=True, optimizer=case, exp=exp)
            c_rounds.append(cr)
